...
def plot_density(
    ...
    *,
    ...
    if converter is not None:
        display_data = converter.convert(data, "density", value_unit)
    else:
        display_data = data
        value_unit = "norm"
    ...
    if converter is not None:
        cbar.set_label(converter.get_label("density", value_unit))
    else:
        cbar.set_label(
...
if __name__ == "__main__":
    ...
    if species_list:
        ...
        plot_density(
            sp, it, sim_path=sim_path, converter=converter,
