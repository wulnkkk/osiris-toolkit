...
_SECTIONS: list[SectionSpec] = [
    ...
    SectionSpec(
        "diag_emf", SectionKind.OPTIONAL,
        description="EM field diagnostics",
    ),
    SectionSpec(
        "pgc", SectionKind.CONDITIONAL,
    ...
    SectionSpec(
        "profile", SectionKind.CONDITIONAL,
        context=SectionContext.SPECIES_GROUP,
    ...
    SectionSpec(
        "spe_bound", SectionKind.OPTIONAL,
        context=SectionContext.SPECIES_GROUP,
        min_repeat=0, max_repeat=None,
        description="Per-species boundary conditions",
    ),
    SectionSpec(
        "piston", SectionKind.CONDITIONAL,
        context=SectionContext.SPECIES_GROUP,
    ...
    SectionSpec(
        "diag_species", SectionKind.OPTIONAL,
        context=SectionContext.SPECIES_GROUP,
        min_repeat=0, max_repeat=None,
    ...
    SectionSpec(
        "diag_current", SectionKind.OPTIONAL,
        description="Current diagnostics",
    ),
    # ---- Antennas ----
    SectionSpec(
        "antenna_array", SectionKind.OPTIONAL,
        description="Antenna array container",
    ),
    SectionSpec(
        "antenna", SectionKind.CONDITIONAL,
