...
- **Trigger:** "find simulations", "list sims", "scan directory", "有哪些模拟", "扫描目录"
...
- **Trigger:** "parse input", "check deck", "validate deck", "解析输入卡"
...
- **Trigger:** "estimate resources", "how much memory", "预估资源", "runtime estimate"
...
- **Trigger:** "plot e1", "plot field", "show field", "画电场图", "显示场"
...
- **Trigger:** "k-space", "FFT", "频谱", "k空间", "frequency domain"
...
- **Trigger:** "density", "species density", "密度图"
...
- **Trigger:** "batch process", "process all", "出图", "处理数据", "批量处理"
...
- **Trigger:** "compare", "side by side", "对比", "比较两个模拟"
...
- **Trigger:** "field energy", "total energy", "EM energy", "场能量"
...
- **Trigger:** "species stats", "particle stats", "粒子统计"
- **CLI:** (no direct CLI command)
...
- **Trigger:** "convert units", "normalized to SI", "单位换算"
- **CLI:** (no direct CLI command)
...
- **Trigger:** "energy over time", "energy history", "能量演化"
- **CLI:** (no direct CLI command)
